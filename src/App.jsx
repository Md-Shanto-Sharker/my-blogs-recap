    ...
    <>
      ...
      <div className="main-container flex text-center">
        <div className="left-container w-[70%]">
          <Blogs handleClicked={handleClicked} handleMarkedASRead={handleMarkedASRead}></Blogs>
        </div>
        ...
        <div className="right-container w-[30%]">
          ...
          {
            bookmarked.map(marked=><p className="bg-red-500 p-2 shadow-2xl m-2 text-white">{marked.title}</p>)
          }
        </div>
      </div>
    </>
